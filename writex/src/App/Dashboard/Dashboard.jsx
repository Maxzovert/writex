            ...
            <ul className="flex flex-row items-center justify-center gap-6">
              {NAVITEMS.map((item, index) => (
                <li key={index}>
                  <a
                    href={item.path}
                    className="relative px-4 py-2 text-gray-700 font-medium hover:text-amber-600 transition-colors duration-200
                             after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-amber-500 
